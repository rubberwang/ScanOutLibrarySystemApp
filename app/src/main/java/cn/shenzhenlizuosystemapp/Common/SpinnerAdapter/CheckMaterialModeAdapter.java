...
public class CheckMaterialModeAdapter extends BaseAdapter {

    private List<CheckMaterialModeBean> data;
    private Context context;

    public CheckMaterialModeAdapter(List<CheckMaterialModeBean> itemData, Context context) {
        this.data = itemData;
