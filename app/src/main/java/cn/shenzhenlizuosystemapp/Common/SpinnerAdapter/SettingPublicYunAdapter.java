...
public class SettingPublicYunAdapter extends BaseAdapter {

    List<Setting_PublicDataBean> data;
    Context context;

    public SettingPublicYunAdapter(List<Setting_PublicDataBean> itemData, Context context) {
        this.data = itemData;
