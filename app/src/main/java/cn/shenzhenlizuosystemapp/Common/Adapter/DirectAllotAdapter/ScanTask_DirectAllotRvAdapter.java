...
public class ScanTask_DirectAllotRvAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHoders viewHoders = new ViewHoders(LayoutInflater.from(parent.getContext()).inflate(R.layout.direct_allot_task_item, parent, false));
        return viewHoders;
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        try {
            ((ViewHoders) holder).TV_noSend.setText(datas.get(position).getFNotAllotQty());
