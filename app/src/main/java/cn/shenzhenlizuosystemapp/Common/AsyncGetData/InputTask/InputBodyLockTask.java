package cn.shenzhenlizuosystemapp.Common.AsyncGetData.InputTask;
...
public class InputBodyLockTask extends AsyncTask<String, Void, String> {
    ...
    public InputBodyLockTask(LockResultPort lockResultPort, WebService webService, String BodyID, MyProgressDialog myProgressDialog) {
