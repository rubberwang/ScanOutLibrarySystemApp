...
public class CheckBodyLockTask extends AsyncTask<String, Void, String> {
    ...
    public CheckBodyLockTask(LockResultPort lockResultPort, WebService webService, String BodyID, MyProgressDialog myProgressDialog) {
