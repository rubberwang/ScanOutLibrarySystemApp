...
public class RvLinearManageDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public RvLinearManageDivider(Context context, int orientation, int drawableId) {
     ...
     */
    public RvLinearManageDivider(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
